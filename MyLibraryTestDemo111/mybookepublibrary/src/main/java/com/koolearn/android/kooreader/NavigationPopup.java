...
//        myKooReader.clearTextCaches();
    ...
    private void createPanel(KooReader activity, RelativeLayout root) {
        if (myWindow != null && activity == myWindow.getContext() && (this.mainMenuWindow != null)) {
            return;
        }
        activity.getLayoutInflater().inflate(R.layout.navigation_panel, root);
        activity.getLayoutInflater().inflate(R.layout.navigation_toppanel, root);

        myWindow = (NavigationWindow) root.findViewById(R.id.navigation_panel);
        mainMenuWindow=(MainMenuWindow)root.findViewById(R.id.navigation_toppanel);
        ...
        TextView tv_back=mainMenuWindow.findViewById(R.id.tv_back);
        TextView tv_addnote=mainMenuWindow.findViewById(R.id.tv_addnote);

        tv_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                removeWindow(myActivity);
                myActivity.finish();
        ...
        tv_addnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(myActivity.getApplicationContext(),"添加书签成功",Toast.LENGTH_LONG).show();
            }
        });
...
//    }
    ...
    final void removeWindow(Activity activity) {
        ...
        if (mainMenuWindow!=null&& activity == mainMenuWindow.getContext()){
            final ViewGroup root = (ViewGroup) mainMenuWindow.getParent();
            mainMenuWindow.hide();
            root.removeView(mainMenuWindow);
            mainMenuWindow=null;
        }
    }
}