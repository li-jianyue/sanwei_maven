...
public final class ZLTextParagraphCursor {
	...
	final com.koolearn.klibrary.text.view.CursorManager CursorManager;
	...
	ZLTextParagraphCursor(com.koolearn.klibrary.text.view.CursorManager cManager, ZLTextModel model, int index) {
