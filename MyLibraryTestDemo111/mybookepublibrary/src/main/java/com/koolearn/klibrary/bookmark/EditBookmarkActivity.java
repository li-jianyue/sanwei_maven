...
package com.koolearn.klibrary.bookmark;
        ...
        if (bgValue != null) {
            switch (bgValue) {
                case "wallpapers/bg_green.png":
                    li.setBackgroundResource(R.mipmap.bg_green);
                    break;
                case "wallpapers/bg_grey.png":
                    li.setBackgroundResource(R.mipmap.bg_grey);
                    break;
                case "wallpapers/bg_night.png":
                    li.setBackgroundResource(R.mipmap.bg_white);
                    break;
                case "wallpapers/bg_vine_grey.png":
                    li.setBackgroundResource(R.mipmap.bg_vine_grey);
                    break;
                case "wallpapers/bg_vine_white.png":
                    li.setBackgroundResource(R.mipmap.bg_vine_white);
                    break;
            ...
            public void onClick(View view) {
                myCollection.bindToService(EditBookmarkActivity.this, new Runnable() {
                    public void run() {
                        ...
                        saveTextButton.setEnabled(false);
                        Toast.makeText(EditBookmarkActivity.this, "笔记修改成功", Toast.LENGTH_LONG).show();
