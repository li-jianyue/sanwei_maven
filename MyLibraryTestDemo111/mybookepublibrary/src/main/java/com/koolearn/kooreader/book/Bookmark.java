...
public final class Bookmark extends ZLTextFixedPosition {
	...
	public Bookmark(IBookCollection collection, Book book, String modelId, TextSnippet snippet, boolean visible,int isNote) {
