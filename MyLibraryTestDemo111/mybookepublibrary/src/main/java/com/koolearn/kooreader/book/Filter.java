...
public abstract class Filter {
	...
	public final static class ByTag extends Filter {
		public final com.koolearn.kooreader.book.Tag Tag;

		public ByTag(com.koolearn.kooreader.book.Tag tag) {
			Tag = tag;
		}

		public boolean matches(AbstractBook book) {
			final List<com.koolearn.kooreader.book.Tag> bookTags = book.tags();
			return
