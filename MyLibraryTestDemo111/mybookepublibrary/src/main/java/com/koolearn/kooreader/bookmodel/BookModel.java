...
public final class BookModel {
    public static BookModel createModel(com.koolearn.kooreader.book.Book book, FormatPlugin plugin) throws BookReadingException {
    ...
    public final com.koolearn.kooreader.book.Book Book;
    public final com.koolearn.kooreader.bookmodel.TOCTree TOCTree = new TOCTree();
    public final com.koolearn.klibrary.core.fonts.FontManager FontManager = new FontManager();
    ...
    protected BookModel(com.koolearn.kooreader.book.Book book) {
        Book = book;
    }
    ...
    private com.koolearn.kooreader.bookmodel.TOCTree myCurrentTree = TOCTree;
