...
//		final NetworkLibrary com.ljy.library = NetworkLibrary.Instance(myView.Application.SystemInfo);
//
//		new Thread() {
//			public void run() {
//				final SimpleOPDSFeedHandler handler = new SimpleOPDSFeedHandler(com.ljy.library, url);
//				try {
//					new QuietNetworkContext().perform(new ZLNetworkRequest.Get(url, true) {
//						@Override
//						public void handleStream(InputStream inputStream, int length) throws IOException, ZLNetworkException {
//							new OPDSXMLReader(com.ljy.library, handler, false).read(inputStream);
//						}
//					});
