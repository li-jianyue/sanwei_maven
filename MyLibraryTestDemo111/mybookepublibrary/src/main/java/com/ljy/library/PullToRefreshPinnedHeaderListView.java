...
import com.ljy.library.internal.EmptyViewMethodAccessor;
import com.ljy.library.internal.LoadingLayout;
import library.pinnedheadlistview.PinnedSectionListView;

public class PullToRefreshPinnedHeaderListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    @TargetApi(9)
    final class InternalListViewSDK9 extends PullToRefreshPinnedHeaderListView.InternalListView {
