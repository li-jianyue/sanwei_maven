...
import com.ljy.library.internal.FlipLoadingLayout;
import com.ljy.library.internal.LoadingLayout;
import com.ljy.library.internal.RotateLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    @Override
    public final void setRefreshing(boolean isCallRefresh) {
        if (!isRefreshing()) {
            setState(State.MANUAL_REFRESHING, true, isCallRefresh);
        }
    }
...
//    }
     ...
     *
     * @param params - Whether the UI should scroll for this event.
     */
    protected void onRefreshing(final boolean... params) {
